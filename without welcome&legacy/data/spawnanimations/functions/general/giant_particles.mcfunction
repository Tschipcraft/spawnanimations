...
# Sand
execute if block ~ ~-1 ~ #minecraft:sand run particle minecraft:block sand ~ ~ ~ 1.5 0 1.5 1 30 normal
# Dirt
execute if block ~ ~-1 ~ #minecraft:bamboo_plantable_on unless block ~ ~-1 ~ #minecraft:sand run particle minecraft:block dirt ~ ~ ~ 1.5 0 1.5 1 30 normal
# Wood
...
execute if block ~ ~-1 ~ cobblestone run particle minecraft:block cobblestone ~ ~ ~ 1.5 0 1.5 1 30 normal
...
# End
execute if block ~ ~-1 ~ end_stone run particle minecraft:block end_stone ~ ~ ~ 1.5 0 1.5 1 30 normal
