...
# Leaves
execute if block ~ ~ ~ #minecraft:leaves run playsound minecraft:block.grass.break hostile @a ~ ~ ~ 0.85 0.9
# Stone
execute if block ~ ~ ~ #minecraft:base_stone_overworld run playsound minecraft:block.stone.break hostile @a ~ ~ ~ 0.85 0.9
execute if block ~ ~ ~ #minecraft:stone_bricks run playsound minecraft:block.stone.break hostile @a ~ ~ ~ 0.85 0.9
execute if block ~ ~ ~ minecraft:cobblestone run playsound minecraft:block.stone.break hostile @a ~ ~ ~ 0.85 0.9
# Other
...
# End
execute if block ~ ~ ~ minecraft:end_stone run playsound minecraft:block.stone.break hostile @a ~ ~ ~ 0.85 0.9
