...
execute if block ~ ~-1 ~ minecraft:obsidian run playsound minecraft:block.stone.break block @a ~ ~ ~ 1 0.4
execute if block ~ ~-1 ~ minecraft:slime_block run playsound minecraft:block.slime_block.break block @a ~ ~ ~ 1 0.4
execute if block ~ ~-1 ~ minecraft:nether_bricks run playsound minecraft:block.nether_bricks.break block @a ~ ~ ~ 1 0.6
...
execute if block ~ ~-1 ~ minecraft:lava run playsound minecraft:block.lava.pop block @a ~ ~ ~ 1 0.6
